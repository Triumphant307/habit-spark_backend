...
export const listSuggestions = async (userId: string, query: SuggestionQuery) => {
...
export const favoriteSuggestion = async (userId: string, data: { tipId: string, isFavorite: boolean }) => {
  return await suggestionRepo.toggleFavorite(userId, data.tipId, data.isFavorite);
};
