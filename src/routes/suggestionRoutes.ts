...
import { suggestionQuerySchema, toggleFavoriteSchema } from '../validators/suggestionValidators.js';
 ...
 */
router.get('/', validate(suggestionQuerySchema, 'query'), suggestionController.getSuggestions);

/**
 * Route: POST /suggestions/fav
 * Payload: { tipId: string, isFavorite: boolean }
 */
router.post('/fav', validate(toggleFavoriteSchema), suggestionController.toggleFavorite);
